"""
Collected from https://github.com/yukkyo/voc2coco/blob/master/voc2coco.py
"""
...
def get_label2id() -> Dict[str, int]:
    ...
    labels_ids = [
        ...
        62,  # chair
        63,  # couch : sofa
        64,  # potted plant : pottedplant
        67,  # dining table : diningtable
        72,  # tv : tvmonitor
    ]
...
if __name__ == '__main__':
    ...
    output = "VOC2012/voc2012_tranformed_to_coco.json"
    ann_ids = "VOC2012/ImageSets/Main/trainval.txt"
    ann_paths_list = None
